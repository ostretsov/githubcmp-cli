...
class GistRenderer extends CliRenderer
{
        ...
        $response = $client->api('gists')->create([
            ...
            'files' => [
                $this->getFilename($repositories) => [
                    'content' => $this->getDecoratedContent($this->getDescription($repositories), $content),
                ],
            ],
        ]);
    ...
    private function getDecoratedContent($title, $consoleOutput)
    {
        return <<<"GIST"
# $title

Generated by [githubcmp-cli](https://github.com/ostretsov/githubcmp-cli)
